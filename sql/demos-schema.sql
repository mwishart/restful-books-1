...
INSERT INTO students (first_name, last_name, cohort, start_date, email, github_id, country) VALUES ("charlie", "nathan","charlie_nathan@tjxeurope.com","charlieNathan2","UK");
INSERT INTO students (first_name, last_name, cohort, email, start_date, github_id, country) VALUES("Mary", "Wishart", "mary_wishart@tjx.com", 5, "2022-01-24", "mwishart", "USA");
 ...
 insert into demos.students (first_name, last_name, cohort,start_date, email, github_id, location) values ('Abdulahad', 'Qureshi', 5, '2022-01-24', 'abdulahad_qureshi@tjxcanada.ca', 'AbdulahadQ99', 'Canada');
 ...
 INSERT INTO students (first_name, last_name, cohort, start_date, email, github_id, country) VALUES ("Phillip", "K","pk@email.com","12345","USA");
 ...
 INSERT INTO students (first_name, last_name, cohort, start_date, email, github_id, country) VALUES ('Katie', 'Mullins','kaitlin_mullins@tjx.com','katie1200','USA');
